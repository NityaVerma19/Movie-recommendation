...
\item \textbf{STEP 2: Singular Value Decomposition:}: 
    \vspace{2pt}
    
    \begin{itemize}
        \item \textbf{\textit{STEP 1: User Matrix}}: This step focuses on building the user-movie correlation matrix on the basis of the ratings given by users to all the movies. 
...
\begin{figure}[H]
        ...
        \centering
        \includegraphics[height=6.6cm]{figures/similarity(item).png}
        \caption{Similarity Matrix}
        \label{similarity}
\end{figure}
